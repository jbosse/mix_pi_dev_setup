...
- **Close docs** → propose updates to `/docs/architecture.md`, `/docs/project_memory.md`, `/CHANGELOG.md` (under "Not yet released"), `/README.md`, and finalize `/docs/sprint/{name}/qa-script.md`.
